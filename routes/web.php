...
use App\Http\Controllers\Reportes2\ReportesController;
...
Route::get('/reportes/ventas-por-cliente', [ReportesController::class, 'ventasPorCliente'])
     ->name('reportes2.ventasPorCliente') // Es buena práctica nombrar las rutas
     ->middleware('auth'); // Opcional: Si quieres que este reporte solo sea accesible por usuarios autenticados
